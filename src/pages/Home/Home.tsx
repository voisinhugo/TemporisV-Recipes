      ...
      <Container>
        ...
        <DescriptionContainer>
          ...
          <DescriptionText>
            ...
            dure du 21 avril au 22 juin 2021. Comme à chaque Temporis, des
            règles spéciales sont ajoutées au jeu. Pour plus d'informations,
            ...
            consommables et idoles sont obtenables contre cinq cartes
            différentes. Chaque combinaison de cinq cartes donne un objet selon
            des recettes à découvrir. Tu pourras trouver sur ce site des
            recettes déjà connues, soit en cherchant le nom d'un item que tu
            veux, soit avec les cartes que tu as en ta possession.{"\n\n"}Bien
            sûr, n'hésite pas à aider les autres joueurs en ajoutant les
            recettes que tu trouves !
          </DescriptionText>
        </DescriptionContainer>
        <DescriptionContainer>
          <DescriptionTitle>
          ...
          <DescriptionText>
            Ces quatre outils proposés par ce site vous serviront pour le
            Chinq :
          </DescriptionText>
          <SectionContainer>
        ...
        <DescriptionContainer>
          ...
          <DescriptionText>
            ...
            <Link href="https://chinq.fr/">chinq.fr</Link> qui me fournit la
            liste des objects obtenables et la liste des cartes de Temporis V.
          </DescriptionText>
        </DescriptionContainer>
      </Container>
      <BottomBanner>
